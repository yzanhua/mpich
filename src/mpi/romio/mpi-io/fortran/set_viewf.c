...
extern FORTRAN_API void FORT_CALL MPI_FILE_SET_VIEW(MPI_Fint *, MPI_Offset *, MPI_Fint *,
...
extern FORTRAN_API void FORT_CALL mpi_file_set_view__(MPI_Fint *, MPI_Offset *, MPI_Fint *,
                                                      MPI_Fint *, char *FORT_MIXED_LEN_DECL,
                                                      MPI_Fint *, MPI_Fint * FORT_END_LEN_DECL);
...
#pragma weak mpi_file_set_view = pmpi_file_set_view
#else
extern FORTRAN_API void FORT_CALL mpi_file_set_view_(MPI_Fint *, MPI_Offset *, MPI_Fint *,
                                                     MPI_Fint *, char *FORT_MIXED_LEN_DECL,
                                                     MPI_Fint *, MPI_Fint * FORT_END_LEN_DECL);

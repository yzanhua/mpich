...
extern FORTRAN_API void FORT_CALL MPI_FILE_OPEN(MPI_Fint *, char *FORT_MIXED_LEN_DECL, MPI_Fint *,
                                                MPI_Fint *, MPI_File *,
                                                MPI_Fint * FORT_END_LEN_DECL);
#pragma weak MPI_FILE_OPEN = PMPI_FILE_OPEN
#elif defined(FORTRANDOUBLEUNDERSCORE)
extern FORTRAN_API void FORT_CALL mpi_file_open__(MPI_Fint *, char *FORT_MIXED_LEN_DECL, MPI_Fint *,
                                                  MPI_Fint *, MPI_File *,
                                                  MPI_Fint * FORT_END_LEN_DECL);
...
#pragma weak mpi_file_open = pmpi_file_open
#else
extern FORTRAN_API void FORT_CALL mpi_file_open_(MPI_Fint *, char *FORT_MIXED_LEN_DECL, MPI_Fint *,
                                                 MPI_Fint *, MPI_File *,
                                                 MPI_Fint * FORT_END_LEN_DECL);
